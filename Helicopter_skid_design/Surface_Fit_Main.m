clc
close all
%%                      MAK 420 PROJECT // HELİCOPTER LANDİNG GEAR DESIGN 

% 1. PURPOSE: Parametric modelling of landing gear 
...
% 3. OUTPUT PARAMETERS
% STL model of the landing gear

% 4. REFERENCES:
% [1] Recep M. Gorguluarslan,TOBB ETU, MAK420 Course Notes and Videos
%%                              FUNCTION BODY
%Open top opt result
