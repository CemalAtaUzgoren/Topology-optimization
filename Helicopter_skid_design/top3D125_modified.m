function xPhys = top3D125_modified(nelx,nely,nelz,volfrac,penal,rmin,ft,ftBC,eta,beta,move,maxit,F,fixed,VoidEl)
% ---------------------------- PRE. 1) MATERIAL AND CONTINUATION PARAMETERS
E0 = 69;                                                                    % Young modulus of solid
...
[ pasS, pasV ] = deal( [], VoidEl );                                           % passive solid and void elements
